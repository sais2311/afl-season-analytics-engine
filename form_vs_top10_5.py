...
ax.set_title("2026 AFL \u2014 Form vs Top 10 (Last 5 Rounds)",
...
plt.savefig("form_vs_top10_5.png", dpi=200, facecolor=BG, bbox_inches="tight")
print("Top 10:", sorted(TOP10))
print("Saved form_vs_top10_5.png | zone:", list(stats[stats.zone].team))