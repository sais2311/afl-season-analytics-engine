...
# the last 10 rounds of the home-and-away season to see who is in the form
...
plt.savefig("form_window_5.png", dpi=200, facecolor=BG, bbox_inches="tight")
print("Saved form_window_5.png |", n_rounds, "rounds | zone:", list(stats[stats.zone].team))